...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('persona', '0002_customer_created_customer_modified_seller_created_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PF',
            fields=[
                ('pessoa_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='persona.pessoa')),
                ('cpf', models.CharField(blank=True, max_length=11, null=True)),
                ('rg', models.CharField(blank=True, max_length=10, null=True)),
            ],
            bases=('persona.pessoa',),
        ),
        migrations.CreateModel(
            name='PJ',
            fields=[
